            ...
            <div class="col-md-12 ">
                ...
                <div class="col-md-12">
                    <a href="../src/controller/seguimiento.php?reporte">
                        <button type="button" class="btn btn-success btn-descarga">Descargar base de datos
                            completa</button>
                    </a>
                    <br><br><br>
            ...
            <div class="modal-dialog modal-xl" role="document" style='width:1200px!important'>
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel"> <b><label style="font-size:16px!important"> SSI
                                    - Sistema de Seguimiento de Inversiones </label></b> </h5>
                            ...
                            <div class='col-md-12'>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading"
                                        style="background:#31708f!important;color:white!important">DATOS DE LA FASE DE
                                        FORMULACIÓN Y EVALUACIÓN</div>
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Fecha de
                                                viabilidad/aprobación</label>
                                            <div class="col-sm-8  text-left">
                                                <span id='span_4'></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Costo de inversión viable/aprobado
                                                (S/)</label>
                                            <div class="col-sm-8  text-left">
                                                <span id='span_5'></span>
                                            </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">¿Tiene expediente técnico o documento
                                                equivalente?</label>
                                            <div class="col-sm-8  text-left">
                                                <span id='span_7'></span>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">¿Tiene registro de
                                                seguimiento?</label>
                                            <div class="col-sm-8  text-left">
                                                <span id='span_8'></span>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Costo de inversión actualizado
                                                (S/)</label>
                                            <div class="col-sm-8  text-left">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading"
                                        style="background:#31708f!important;color:white!important">INFORMACIÓN
                                        FINANCIERA (S/)</div>
                                    <div class="panel-body">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading"
                                        style="background:#31708f!important;color:white!important">HISTÓRICO DE
                                        DEVENGADO POR ESPECÍFICA (S/.)</div>
                                    <div class="panel-body">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading"
                                        style="background:#31708f!important;color:white!important">FORMATO 12B</div>
                                    <div class="panel-body">
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading"
                                                style="background:#B00000!important;color:white!important">Ejecución de
                                                la inversión</div>
                                            <div class="panel-body">

                                                <div class="form-group row">
                                                    <label class="col-sm-4 col-form-label">Fecha de inicio de la
                                                        ejecución física</label>
                                                    <div class="col-sm-8  text-left">
                                                        <span id='span_28'></span>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-4 col-form-label">Fecha de culminación de la
                                                        ejecución física</label>
                                                    <div class="col-sm-8  text-left">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-sm-4 col-form-label">Link Detalle de
                                                        avance</label>
                                                    <div class="col-sm-8  text-left">
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading"
                                                        style="background:#AF7070;color:white!important">Información del
                                                        avance de la inversión</div>
                                                    <div class="panel-body">

                                                        <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label">% Avance de la
                                                                ejecución de la inversión</label>
                                                            <div class="col-sm-8  text-left">
                                                                <span id='span_21'></span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label">% Avance físico de la
                                                                inversión</label>
                                                            <div class="col-sm-8  text-left">
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading"
                                                        style="background:#AF7070;color:white!important">Situación</div>
                                                    <div class="panel-body">
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading"
                                                        style="background:#AF7070;color:white!important">Problemática -
                                                        Riesgo en la fase de ejecución</div>
                                                    <div class="panel-body">
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading"
                                                style="background:#B00000!important;color:white!important">Ejecución
                                                Financiera</div>
                                            <div class="panel-body">

                                                <div class="panel panel-default">
                                                    <div class="panel-heading"
                                                        style="background:#AF7070;color:white!important">Avance
                                                        financiero acumulado de la inversión</div>
                                                    <div class="panel-body">

                                                        <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label">Costo
                                                                actualizado</label>
                                                            <div class="col-sm-8  text-left">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label">Devengado
                                                                acumulado</label>
                                                            <div class="col-sm-8  text-left">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label">Primer
                                                                devengado</label>
                                                            <div class="col-sm-8  text-left">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label">Último
                                                                devengado</label>
                                                            <div class="col-sm-8  text-left">
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading"
                                                        style="background:#AF7070;color:white!important">Avance
                                                        financiero de la inversión</div>
                                                    <div class="panel-body">

                                                        <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label">Programación
                                                                financiera actualizada</label>
                                                            <div class="col-sm-8  text-left">
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading"
                                                style="background:#B00000!important;color:white!important">
                                                Contrataciones</div>
                                            <div class="panel-body">
