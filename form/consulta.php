...
<!--                                                                    <div id="divDatos">
      ...
      <div class="row">
          ...
          <div class="col-md-12">
                  ...
                  <a href="../src/controller/consulta.php?reporte">
                    ...
                    <br><br><br>
                           ...
                           <div class="col-md-12">
                            ...
                            <div class="col-md-2" id="divBloque1">
                                <div class="panel panel-info">
                                    ...
                                    <div class="panel-body row">
                                        ...
                                        <div class="col-md-12 text-center">
                                            <button id="btnCategoriaPresupuestal" class="btn btn-secondary">Categoría Presupuestal</button> 
                                            <center>
                                            <span class="label label-danger" id="lbCategoriaPresupuestal" style="display:none;cursor:pointer;width:20px;margin-top:10px">X</span>
                                            </center>
                                        </div>
                                        <div class="col-md-12 text-center">&nbsp;</div>
                                        <div class="col-md-12 text-center">
                                        ...
                                        <div class="col-md-12 text-center">
                                            ...
                                            <center>
                                            <span class="label label-danger" id="lbDivisionFuncional" style="display:none;cursor:pointer;width:20px;margin-top:10px">X</span>
                                            </center>
                                        </div>
                                        <div class="col-md-12 text-center">&nbsp;</div>
                                        <div class="col-md-12 text-center">
                                            ...
                                            <center>
                                            <span class="label label-danger" id="lbGrupoFuncional" style="display:none;cursor:pointer;width:20px;margin-top:10px">X</span>
                                            </center>
                                        </div>
                            ...
                            <div class="col-md-3" id="divBloque3">
                                    <div class="panel panel-info">
                                        <div class="panel-heading panelHeading" style="background:#002747!important;">
                                            <center>
                                        ...
                                        <div class="panel-body row">
                                            ...
                                            <div class="col-md-12 text-center">&nbsp;</div>
                                            <div class="col-md-12 text-center">
                                                <button id="btnDetalleSubgenerica" class="btn btn-secondary">Detalle sub-genérica</button> 
                                                <center>
                            ...
                            <div class="col-md-2" id="divBloque4">
                                    <div class="panel panel-info">
                                        <div class="panel-heading panelHeading" style="background:#002747!important;">
                                            <center>
                                            <label class="nombreFiltro" style="color:white!important">¿Cuándo se hizo el gasto?</label>
                                            </center>
                                        </div>
                                        <div class="panel-body row">
                                            <div class="col-md-12 text-center">
            ...
            <div class="row col-md-12" style="margin-left:15px!important">
            <?php }?>
