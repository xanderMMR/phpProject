    ...
    <section class="ftco-section fondo-row-table">
        <div class="row row-table">
            ...
            <div class="row">
                ...
                <div class="col-xl-2 col-lg-6 col-md-6" id="divBloque1">
                    <div class="panel panel-info">
                        <div class="panel-heading panelHeading" style="background:#002747!important;">
                            <center>
                                <label class="nombreFiltro" style="color:white!important">¿De qué fuentes proviene la
                                    recaudación?</label>
                            </center>
                        </div>
                        <div class="panel-body row">
                ...
                <div class="col-xl-2 col-lg-6 col-md-6" id="divBloque2">
                    <div class="panel panel-info">
                        <div class="panel-heading panelHeading" style="background:#002747!important;">
                            <center>
                                <label class="nombreFiltro" style="color:white!important">¿Cómo se estructura la
                                    recaudación?</label>
                            </center>
                        </div>
                        <div class="panel-body row">
                ...
                <div class="col-xl-2 col-lg-6 col-md-6" id="divBloque3">
                    <div class="panel panel-info">
                        <div class="panel-heading panelHeading" style="background:#002747!important;">
                            <center>
                                <label class="nombreFiltro" style="color:white!important">¿Cuándo se hizo la
                                    recaudación?</label>
                            </center>
                        </div>
                        <div class="panel-body row">
