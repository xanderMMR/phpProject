...
<html>
    <head>
        ...
        $(document).ready(function() {
            ...
            function filtrar(tipoVista){
                ...
                if(document.getElementById("tablaDatos")!==null){
                    ...
                    if(radioSel !== undefined){
                        ...
                        $("#divDatos").load( "../src/controller/transferencia.php", 
                        {
                            resultado:'1',
                            ...
                            quitar:"",
                            t_autorizado: $("#autorizado_"+radioNum).val(),
                            t_acreditado: $("#acreditado_"+radioNum).val()
                        });
            ...
            $("#lbRecurso").click(function(){
                regresarFiltro("RECURSO");
            });
    ...
    <body>
      ...
      <div class="row row-table">
          ...
          <div class="col-md-12">
              <center>
                <label style="font-size:30px;color:#002747"><b>TRANSFERENCIAS</b></label>
              </center>
          </div>
          ...
          <div class="row">
                ...
                <div class="col-xl-2 col-lg-6 col-md-12" id="divBloque1">
                    <div class="panel panel-info">
                        <div class="panel-heading panelHeading" style="background:#002747!important;">
                            <center>
                                <label class="nombreFiltro" style="color:white!important">¿Cuándo se realizaron las transferencias?</label>
                            </center>
                        </div>
                        <div class="panel-body row">
                ...
                <div class="col-xl-2 col-lg-6 col-md-12" id="divBloque2">
                    <div class="panel panel-info">
                        <div class="panel-heading panelHeading" style="background:#002747!important;">
                            <center>
                            <label class="nombreFiltro" style="color:white!important">¿A qué fuentes pertenecen los recursos?</label>
                            </center> 
                        </div>
                        <div class="panel-body row">

                            <div class="col-md-12 text-center">
                                <button id="btnFuente" class="btn btn-secondary">Fuentes</button> 
                                <center>
                ...
                <div class="col-xl-2 col-lg-6 col-md-12" id="divBloque3">
                    <div class="panel panel-info">
                        <div class="panel-heading panelHeading" style="background:#002747!important;">
                            <center>
                                <label class="nombreFiltro" style="color:white!important">¿Qué recursos se transfirieron?</label>
                            </center>
                        </div>
                        <div class="panel-body row">

                            <div class="col-md-12 text-center">
                                <button id="btnRecurso" class="btn btn-secondary">Recursos</button> 
                                <center>
                                <span class="label label-danger" id="lbRecurso" style="display:none;cursor:pointer;width:20px;margin-top:10px">X</span>
                                </center>
                            </div>
