...
<body>
    ...
    <div class="container-fluid row">
        <div class="row">
            <div class="bg-image col-xl-6 col-lg-6 col-md-12">
                
            </div>

            <div class="bg-light col-xl-6 col-lg-6 col-md-12 panelLogin">
                                ...
                                <form method="POST" action="./../src/controller/login.php?movil=1">
                                    ...
                                    <form method="POST" action="./../src/controller/login.php">
                                        ...
                                        <div class="form-group mb-3">
                                            <input autocomplete="off" id="inputEmail" name="correo" type="email"
                                                placeholder="Correo electrónico" autofocus=""
                                                class="input-form form-control rounded-pill border-0 shadow-sm px-4">
                                        </div>
                                        <div class="form-group mb-3">
                                            <input id="inputPassword" name="clave" type="password" placeholder="Clave"
                                                class="input-form form-control rounded-pill border-0 shadow-sm px-4 text-primary">
                                        </div>
                                        <!--
                                        ...
                                        -->
                                        <button type="submit"
                                            class="btn btn-primary btn-block text-uppercase mb-2 rounded-pill shadow-sm buttonLogin">Ingresar</button>
                                        ...
                                        <div class="col-md-12">
                                            <label class="labelRegistro"><a data-toggle="modal"
                                                    data-target="#loginModal">Regístrate aquí</a></label>
                                        </div>
                                        <div class="col-md-12">
                                            <label class="labelRegistro"><a data-toggle="modal"
                                                    data-target="#loginRecuperar">Recuperar contraseña</a></label>
                                        </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex flex-column text-center panelRegistro">
                        ...
                        <div class="form-group">
                            <input maxlength="50" onpaste="return false" autocomplete="off" type="text"
                                class="form-control inputAcceso" id="nombre" placeholder="Nombre"
                                onkeypress="return letra(event)">
                            <label class="obligatorio" id="l_nombre"></label>
                        </div>
                        <div class="form-group">
                            <input maxlength="50" onpaste="return false" autocomplete="off" type="text"
                                class="form-control inputAcceso" id="paterno" placeholder="Apellido Paterno"
                                onkeypress="return letra(event)">
                            <label class="obligatorio" id="l_paterno"></label>
                        </div>
                        <div class="form-group">
                            <input maxlength="50" onpaste="return false" autocomplete="off" type="text"
                                class="form-control inputAcceso" id="materno" placeholder="Apellido Materno"
                                onkeypress="return letra(event)">
                            <label class="obligatorio" id="l_materno"></label>
                        </div>
                        <div class="form-group">
                            <input maxlength="8" onpaste="return false" autocomplete="off" type="text"
                                class="form-control inputAcceso" id="dni" placeholder="DNI"
                                onkeypress="return numero(event)">
                            <label class="obligatorio" id="l_dni"></label>
                        </div>
                        <div class="form-group">
                            <input maxlength="15" onpaste="return false" autocomplete="off" type="text"
                                class="form-control inputAcceso" id="telefono" placeholder="Teléfono"
                                onkeypress="return numero(event)">
                            <label class="obligatorio" id="l_telefono"></label>
                        </div>
                        <div class="form-group">
                            <input maxlength="100" onpaste="return false" autocomplete="off" type="text"
                                class="form-control inputAcceso" id="correo" placeholder="Correo electrónico"
                                onkeypress="return alfanum(event)">
                            <label class="obligatorio" id="l_correo"></label>
                        </div>
                        <div class="form-group">
                            <input maxlength="50" onpaste="return false" autocomplete="off" type="password"
                                class="form-control inputAcceso" id="clave" placeholder="Clave">
                        ...
                        <div class="form-group" id="divOtro" style="display:none">
                            <input maxlength="100" onpaste="return false" autocomplete="off" type="text"
                                class="form-control" id="otro" placeholder="Ingresar nombre"
                                onkeypress="return letra(event)">
                            <label class="obligatorio" id="l_otro"></label>
                        </div>
                        <div class="col-md-12">&nbsp;</div>
                        <button type="button" id="buttonRegister"
                            class="btn btn-info btn-block btn-round inputAcceso">Registrarme</button>
    ...
    <div class="modal fade" id="loginRecuperar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex flex-column text-center panelRegistro">
                        ...
                        <div class="form-group">
                            <input maxlength="50" onpaste="return false" autocomplete="off" type="text"
                                class="form-control inputRecuperar" id="correoRegistrado"
                                placeholder="Ingrese su correo electrónico registrado"
                                onkeypress="return alfanum(event)">
                            <label class="obligatorio" id="l_correoRegistrado"></label>
                        </div>
                        <div class="col-md-12">&nbsp;</div>
                        <button type="button" id="buttonRecuperar"
                            class="btn btn-info btn-block btn-round inputAcceso">Recuperar</button>
